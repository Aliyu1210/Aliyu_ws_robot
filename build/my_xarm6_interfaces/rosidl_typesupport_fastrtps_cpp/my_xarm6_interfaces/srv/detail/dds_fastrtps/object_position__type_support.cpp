...
#include "my_xarm6_interfaces/srv/detail/object_position__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_xarm6_interfaces::srv::ObjectPosition_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_xarm6_interfaces::srv::ObjectPosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_xarm6_interfaces::srv::ObjectPosition_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectPosition_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_xarm6_interfaces::srv::ObjectPosition_Request *>(
...
static size_t _ObjectPosition_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ObjectPosition_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ObjectPosition_Request__callbacks = {
...
static rosidl_message_type_support_t _ObjectPosition_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectPosition_Request__callbacks,
...
{
  return &my_xarm6_interfaces::srv::typesupport_fastrtps_cpp::_ObjectPosition_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_xarm6_interfaces::srv::ObjectPosition_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_xarm6_interfaces::srv::ObjectPosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_xarm6_interfaces::srv::ObjectPosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjectPosition_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_xarm6_interfaces::srv::ObjectPosition_Response *>(
...
static size_t _ObjectPosition_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ObjectPosition_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ObjectPosition_Response__callbacks = {
  "my_xarm6_interfaces::srv",
...
static rosidl_message_type_support_t _ObjectPosition_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjectPosition_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &my_xarm6_interfaces::srv::typesupport_fastrtps_cpp::_ObjectPosition_Response__handle;
}
...
static service_type_support_callbacks_t _ObjectPosition__callbacks = {
  "my_xarm6_interfaces::srv",
  "ObjectPosition",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_xarm6_interfaces, srv, ObjectPosition_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_xarm6_interfaces, srv, ObjectPosition_Response)(),
...
static rosidl_service_type_support_t _ObjectPosition__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &my_xarm6_interfaces::srv::typesupport_fastrtps_cpp::_ObjectPosition__handle;
}
